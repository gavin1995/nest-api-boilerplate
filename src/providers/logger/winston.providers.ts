...
export const createNestWinstonLogger = (loggerOpts: WinstonModuleOptions): WinstonLogger => {
...
export const createWinstonAsyncProviders = (options: WinstonModuleAsyncOptions): Provider[] => {
